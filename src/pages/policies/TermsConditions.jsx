...
import { TermsAndConditions as termsData } from "../../data/TermsAndCondition";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
            Please read these terms carefully before using the website of{" "}
        ...
        <div className="mt-10 bg-yellow-100 border-l-4 border-yellow-500 p-5 rounded-lg shadow-sm mb-5">
          <p className="text-gray-800 text-sm md:text-base">
            ⚠️ <strong>Note:</strong> By using this website, you agree to comply
            with these Terms & Conditions. Any misuse or non-compliance may lead
